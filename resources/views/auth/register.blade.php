...
@section('content')
    <div dir="rtl">
        <form  method="post" action="{{ route('register.perform') }}">
            ...
            <h1 class="h3 mb-3 fw-normal">تسجيل حساب جديد</h1>
            ...
            <div class="form-group form-floating mb-3">
                ...
                <label for="floatingName">إسم المستخدم</label>
            ...
            <button class="w-100 btn btn-lg btn-primary" type="submit">تســجيل</button>
